...
syn keyword solKeyword           abstract anonymous as assembly break calldata case catch constant constructor continue default
...
syn keyword solNatSpec           @title @author @notice @dev @param @return contained
